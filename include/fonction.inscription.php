...
use PHPMailer\PHPMailer\SMTP;
    ...
    function emailInscription($email,$pseudo,$token){
        ...
        try{
            ...
            $mail->Body = '<html><body>Pour valider votre email cliquez ici -> <a href="localhost/DevWebProjetFleur/confirmation.php?token='.$token.'">localhost/DevWebProjetFleur/confirmation.php?token='.$token.'</a></body></html>';
